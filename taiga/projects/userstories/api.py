...
class UserStoryViewSet(AssignedUsersSignalMixin, OCCResourceMixin,
    ...
    def _add_taiga_info_headers(self):
        ...
        if project_id:
            # Add this header to show if there is there is any user story without swimlane.
            # Useful to draw 'without swimlane' option in swimlane selector at create/edit forms.
